function Home() {
  const people = [
    {
      ...
      imageUrl: 'https://media.istockphoto.com/id/1301234881/photo/portrait-of-successful-hispanic-business-man-looks-directly-at-the-camera-smile-happy-male.webp?a=1&b=1&s=612x612&w=0&k=20&c=EXlYVOFj2q5YtwYSpU60XPK7OGNMYU-eOLdQNrMPKUo=',
    },
    {
      name: 'Sueann Anita',
  ...
  return (
    <div className="bg-blue-100 min-h-screen"> {/* Light blue background for the whole page */}
        ...
        <div className="max-w-full mx-auto px-8 lg:px-8">
          ...
          <div className="mt-12 flex justify-center">
            <div className="grid grid-cols-2 gap-4 max-w-4xl">
              <img className="rounded-xl object-cover w-full h-48 sm:h-64" src="https://images.unsplash.com/photo-1569878766010-17bff0a1987d?w=500&auto=format&fit=crop&q=60" alt="Teamwork 1"/>
              <img className="rounded-xl object-cover w-full h-48 sm:h-64" src="https://images.unsplash.com/photo-1585779034823-7e9ac8faec70?w=500&auto=format&fit=crop&q=60" alt="Teamwork 2"/>
              <img className="rounded-xl object-cover w-full h-48 sm:h-64" src="https://images.unsplash.com/photo-1532012197267-da84d127e765?w=500&auto=format&fit=crop&q=60" alt="Teamwork 3"/>
              <img className="rounded-xl object-cover w-full h-48 sm:h-64" src="https://media.istockphoto.com/id/483636107/photo/businesspeople-in-office-meeting.webp?a=1&b=1&s=612x612&w=0&k=20&c=b-iEWi0KrFrLKu1CvrhKBh1XD8XujBngtZsOkq2aYAs=" alt="Teamwork 4"/>
            </div>
          </div>
          <div className="mt-16">
